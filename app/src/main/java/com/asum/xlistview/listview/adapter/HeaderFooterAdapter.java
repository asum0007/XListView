...
//     */
//    public HeaderFooterAdapter(@NonNull RecyclerView.Adapter innerAdapter) {
...
//        if (!(viewToAdd instanceof XBaseRecyclerViewItem)) {
//            viewToAdd.setTag(-1);
//        } else {
//            viewToAdd.setTag(1);
//        }
...
//            } else {
//                layoutParams = new StaggeredGridLayoutManager.LayoutParams(
//                        viewToAdd.getLayoutParams().WRAP_CONTENT,
//                        viewToAdd.getLayoutParams().WRAP_CONTENT
//                );
//            }
//
